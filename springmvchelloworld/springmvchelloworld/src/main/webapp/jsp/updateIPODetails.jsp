		...
		<div class="row">
			...
			<div>
				<div class="col-sm-6">
					<div class="card">
						<div class="card-body">
							<h3 class="card-title text-center" align="center"><span class="glyphicon glyphicon-edit"></span>  IPO
								Registration</h3>
							<hr>
							<form:form class="form" role="form" autocomplete="off" action="/updateIPODetails" modelAttribute="ipo">
								...
								<div class="form-group row">
									...
									<div class="col-lg-8">
										<form:input class="form-control" type="number" path="total_no_of_shares" placeholder="Enter Total Number Of Share" required="required" min="0" value="a"/>
									</div>
								</div>
								<div class="form-group row">
