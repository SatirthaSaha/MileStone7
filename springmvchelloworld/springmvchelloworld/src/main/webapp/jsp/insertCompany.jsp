		...
		<div class="row">
			...
			<div>
				<div class="col-sm-6">
					<div class="card">
						<div class="card-body">
							<h3 class="card-title text-center" align="center"><span class="glyphicon glyphicon-edit"></span>  Create New Company</h3>
							<hr>
							<form:form class="form" role="form" autocomplete="off" action="/insertCompany" modelAttribute="e1">
								...
								<div class="form-group row">
									...
									<div class="col-lg-8">
										<form:input class="form-control" type="number" path="stock_Code" placeholder="Enter Stock Code" required="required" value="stock_Code"/>
									</div>
								</div>
								<div class="form-group row">
